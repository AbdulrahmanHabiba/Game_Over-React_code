...
export default function Home() {
  ...
  return (
    <div className="">
      <header className="home_header p-3 d-flex align-items-center justify-content-center  py-sm-5 ">
      ...
      <div className="container">
        <h3 className="new-light-color mt-3">
          ...
          {!isLoading ? AllGames.slice(0, 3).map((game, index) => (
            <div className="col-md-4" key={index}>
             ...
             <Link className=" text-decoration-none" to={"/details/"+game.id}>
                ...
                <div className="card_footer p-3 text-white d-flex align-items-center justify-content-between mb-5 ">
                  <p>{game.title}</p>
            ...
            <div className=" d-flex align-items-center  mb-5 pb-5 justify-content-center">
            <SpinnerRoundFilled className='mb-5 pb-5'  size={200} color={'#0DC3E7'} /></div> } 
        </div>
